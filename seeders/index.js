...
async function seedRouteRole () {
  try {
    const routeRoles = [ 
      ...
      {
        route: '/client/api/v1/booking/create',
        role: 'User',
        method: 'POST'
      },
      {
      ...
      {
        route: '/client/api/v1/booking/addbulk',
        role: 'User',
        method: 'POST'
      },
      {
      ...
      {
        route: '/client/api/v1/booking/list',
        role: 'User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/client/api/v1/booking/:id',
        role: 'User',
        method: 'GET' 
      },
      {
      ...
      {
        route: '/client/api/v1/booking/count',
        role: 'User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/client/api/v1/booking/update/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/client/api/v1/booking/partial-update/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/client/api/v1/booking/updatebulk',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/client/api/v1/booking/softdelete/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/client/api/v1/booking/softdeletemany',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/client/api/v1/booking/delete/:id',
        role: 'User',
        method: 'DELETE'
      },
      {
      ...
      {
        route: '/client/api/v1/booking/deletemany',
        role: 'User',
        method: 'POST'
      },
      {
